    ...
    >
      <el-form-item label="分享用户名">
        ...
        <el-col :span="2" align="center">
          <el-tooltip
            content="镜像分享时所需要的贡献用户名，建议设置为Github用户名，方便进行统计贡献。"
            placement="top"
          >
      ...
      <el-form-item label="Dockerhub 用户名">
        ...
        <el-col :span="2" align="center">
          <el-tooltip
            content="镜像分享时所需的登陆用户名，默认情况下无需修改。"
            placement="top"
          >
            <i class="el-icon-question"></i>
          </el-tooltip>
      ...
      <el-form-item label="Dockerhub Token">
        ...
        <el-col :span="2" align="center">
          <el-tooltip
            content="镜像分享时所需的登陆凭证，默认情况下无需修改。"
            placement="top"
          >
            <i class="el-icon-question"></i>
          </el-tooltip>
      ...
      <el-form-item label="镜像过期时间（秒）">
        ...
        <el-col :span="2" align="center">
          <el-tooltip
            content="镜像获取时间，默认为 30 分钟，最小为 1 分钟，0 为永不过期，修改后下次启动镜像开始生效。"
            placement="top"
          >
            <i class="el-icon-question"></i>
          </el-tooltip>
      ...
      <el-form-item label="洞态IAST一键安装配置">
        <el-col :span="20">
          <el-input v-model="data.agent_install_cmd"></el-input>
        </el-col>
        <el-col :span="2" align="center">
          <el-tooltip
            content="洞态 agent 的安装命令，修改为一键启动命令，用于在容器中自动寻找Java进程并安装检测引擎。"
            placement="top"
          >
            <i class="el-icon-question"></i>
          </el-tooltip>
...
export default {
  ...
  methods: {
    ...
    settingUpdate() {
      ...
      formData.set("agent_install_cmd", this.data.agent_install_cmd);
      this.loading = true;
